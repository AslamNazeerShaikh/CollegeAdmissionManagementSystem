...
public partial class CrmViewModel : ViewModelBase
{
    ...
    // Sections (x:Load bindings drive visibility, no converter needed)
    ...
    // Pipeline tabs (stage tabs + vertical list, zero horizontal scroll).
    // String param keeps XAML converter-free; the page paints labels,
    // counts and the active highlight from these in code-behind.
    [ObservableProperty]
