# Graph Report - CollegeAdmissionManagementSystem  (2026-09-12)

## Corpus Check
- 117 files · ~103,498 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 460 nodes · 543 edges · 36 communities (28 shown, 6 thin omitted)
- Extraction: 88% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 62 edges (avg confidence: 0.86)
...
- Final Year Advanced Topics
- Agent Command Catalog
- Dev Skills Knowledge Base
- Biotechnology Curriculum
- MSc Computer Science Year 2
- Business Administration Curriculum
- MSc Computer Management Year 1
- MSc Computer Management Year 2
- MSc Software Engineering Year 1
- Computing Third Year
- MSc Software Engineering Year 2
- Computing First Year
- Graphify Pipeline Reference
- Android Test Scaffolding
- BSc Software Engineering Year 1
- MSc Biotechnology Year 1
- MSc Biotechnology Year 2
- App UI Screenshots
- Migration Modernization Plans
- App Illustration Assets
...
- Launcher Branding XXHDPI
- REST Design Principles

## God Nodes (most connected - your core abstractions)
1. `B.Sc. Network Technology S.Y. Program` - 14 edges
2. `B.Sc. Network Technology T.Y. Program` - 14 edges
3. `B.Sc. Software Engineering S.Y. Program` - 14 edges
4. `B.Sc. Software Engineering T.Y. Program` - 14 edges
5. `M.Sc. Computer Management S.Y. Program` - 14 edges
6. `M.Sc. Computer Science F.Y. Program` - 14 edges
7. `M.Sc. Computer Science S.Y. Program` - 14 edges
8. `M.Sc. System Administration and Networking F.Y. Program` - 14 edges
9. `M.Sc. System Administration and Networking S.Y. Program` - 14 edges
10. `Registration` - 13 edges
...
- **Biotechnology FY to TY progression** — app_src_main_assets_cbcs_bsc_bt_fy_bsc_biotechnology_first_year, app_src_main_assets_cbcs_bsc_bt_sy_bsc_biotechnology_second_year, app_src_main_assets_cbcs_bsc_bt_ty_bsc_biotechnology_third_year, app_src_main_assets_cbcs_bsc_bt_fy_microbiology [INFERRED 0.75]
- **Programming ladder from C to C++ Java and advanced stacks** — app_src_main_assets_cbcs_bca_fy_programming_in_c, app_src_main_assets_cbcs_bca_sy_object_oriented_programming_cpp, app_src_main_assets_cbcs_bca_sy_java_programming, app_src_main_assets_cbcs_bca_ty_advance_java, app_src_main_assets_cbcs_bsc_cs_ty_python_programming [INFERRED 0.75]
- **Network administration progression track** — app_src_main_assets_cbcs_bsc_nt_sy_network_administration, app_src_main_assets_cbcs_bsc_nt_ty_network_administration_part_ii, app_src_main_assets_cbcs_msc_sa_sy_network_administration_part_ii [INFERRED 0.85]
- **Linux administration progression track** — app_src_main_assets_cbcs_bsc_nt_sy_linux_administration, app_src_main_assets_cbcs_bsc_nt_ty_linux_administration_part_ii, app_src_main_assets_cbcs_msc_sa_sy_linux_administration_part_ii [INFERRED 0.85]
- **CBCS elective choice system** — app_src_main_assets_cbcs_bsc_se_sy_program, app_src_main_assets_cbcs_bsc_se_sy_computer_algorithms, app_src_main_assets_cbcs_bsc_se_sy_theory_of_computation, app_src_main_assets_cbcs_bsc_se_sy_internet_technologies_with_php [EXTRACTED 1.00]
...
- **Flat Admission Illustration System** — app_src_main_res_drawable_boy_paper_applicant_form_illustration, app_src_main_res_drawable_certificate_flat_certificate_document_illustration, app_src_main_res_drawable_course_flat_course_badge_illustration, app_src_main_res_drawable_table_chair_classroom_furniture_illustration [INFERRED 0.75]
- **College Brand Identity** — app_src_main_ic_launcher_playstore_graduates_launcher_icon, app_src_main_res_drawable_old_logo_institution_logo, app_src_main_ic_launcher_playstore_college_branding_identity [INFERRED 0.75]
- **Launcher Icon Density Variant Set (hdpi/mdpi/xhdpi)** — app_src_main_res_mipmap_hdpi_ic_launcher_launcher_icon, app_src_main_res_mipmap_hdpi_ic_launcher_foreground_foreground_layer, app_src_main_res_mipmap_hdpi_ic_launcher_round_round_icon [INFERRED 0.85]
- **Launcher Icon Density Variants** — app_src_main_res_mipmap_xxhdpi_ic_launcher_launcher_icon, app_src_main_res_mipmap_xxhdpi_ic_launcher_app_branding [INFERRED 0.85]
- **MSc SE Second Year Curriculum** — app_src_main_assets_cbcs_msc_se_sy_msc_se_second_year, app_src_main_assets_cbcs_msc_se_sy_advanced_java_programming, app_src_main_assets_cbcs_msc_se_sy_advanced_database_administration, app_src_main_assets_cbcs_msc_se_sy_distributed_operating_system, app_src_main_assets_cbcs_msc_se_sy_fuzzy_system_and_ann, app_src_main_assets_cbcs_msc_se_sy_elective_iii, app_src_main_assets_cbcs_msc_se_sy_data_mining, app_src_main_assets_cbcs_msc_se_sy_digital_image_processing, app_src_main_assets_cbcs_msc_se_sy_asp_net_through_c_net, app_src_main_assets_cbcs_msc_se_sy_elective_iv, app_src_main_assets_cbcs_msc_se_sy_open_elective [EXTRACTED 1.00]

## Communities (36 total, 6 thin omitted)

### Community 0 - "Android App Activities"
Cohesion: 0.08
...
### Community 1 - "Opencode Tool Config"
Cohesion: 0.06
Nodes (35): agents, default, list, chmod 777 *, rm -rf *, sudo *, commands, custom (+27 more)

### Community 2 - "Network Administration Curriculum"
Cohesion: 0.06
...
### Community 3 - "Software Engineering Second Year"
Cohesion: 0.07
...
### Community 4 - "Second Year Core Subjects"
Cohesion: 0.10
Nodes (28): BCA Second Year (Sem III-IV), Data Structure, Java Programming, Logical Reasoning, Numerical Aptitude, Object Oriented Programming using C++, Operating System, Relational Database Management System (+20 more)

### Community 5 - "Final Year Advanced Topics"
Cohesion: 0.07
...
### Community 6 - "Agent Command Catalog"
Cohesion: 0.11
...
### Community 7 - "Dev Skills Knowledge Base"
Cohesion: 0.12
...
### Community 8 - "Biotechnology Curriculum"
Cohesion: 0.12
...
### Community 9 - "MSc Computer Science Year 2"
Cohesion: 0.12
...
### Community 10 - "Business Administration Curriculum"
Cohesion: 0.15
...
### Community 11 - "MSc Computer Management Year 1"
Cohesion: 0.13
Nodes (15): Next Generation Networks, Operating System, Software Engineering, Adhoc and Sensor Networks, Elements of Information Technology, Introduction to Programming in C, Management Information System, Next Generation Networks (+7 more)

### Community 12 - "MSc Computer Management Year 2"
Cohesion: 0.13
...
### Community 13 - "MSc Software Engineering Year 1"
Cohesion: 0.17
...
### Community 14 - "Computing Third Year"
Cohesion: 0.25
...
### Community 15 - "MSc Software Engineering Year 2"
Cohesion: 0.18
...
### Community 16 - "Computing First Year"
Cohesion: 0.49
Nodes (10): Basics of Computer System, BCA First Year (Sem I-II), Communication and Soft Skills, Database Management System, Fundamental of Digital Logic, Programming in C, Statistical Techniques in Computer Science, Web Technology (+2 more)

### Community 17 - "Graphify Pipeline Reference"
Cohesion: 0.22
...
### Community 18 - "Android Test Scaffolding"
Cohesion: 0.33
...
### Community 19 - "BSc Software Engineering Year 1"
Cohesion: 0.22
...
### Community 20 - "MSc Biotechnology Year 1"
Cohesion: 0.22
...
### Community 21 - "MSc Biotechnology Year 2"
Cohesion: 0.22
...
### Community 22 - "App UI Screenshots"
Cohesion: 0.28
...
### Community 23 - "Migration Modernization Plans"
Cohesion: 0.38
...
### Community 24 - "App Illustration Assets"
Cohesion: 0.40
...
- **What is the exact relationship between `Back Navigation Button` and `Admission Flat Illustration Set`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `B.Sc. Network Technology S.Y. Program` connect `Second Year Core Subjects` to `MSc Computer Science Year 2`, `MSc Computer Management Year 1`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `B.Sc. Software Engineering T.Y. Program` connect `Final Year Advanced Topics` to `Network Administration Curriculum`, `MSc Computer Management Year 1`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **What connects `$schema`, `version`, `name` to the rest of the system?**
  _249 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Android App Activities` be split into smaller, more focused modules?**
  _Cohesion score 0.08220211161387632 - nodes in this community are weakly interconnected._
- **Should `Opencode Tool Config` be split into smaller, more focused modules?**
  _Cohesion score 0.05555555555555555 - nodes in this community are weakly interconnected._
- **Should `Network Administration Curriculum` be split into smaller, more focused modules?**
