...
6. `M.Sc. Computer Management S.Y. Program` - 14 edges
7. `B.Sc. Network Technology T.Y. Program` - 14 edges
8. `M.Sc. System Administration and Networking S.Y. Program` - 14 edges
9. `B.Sc. Software Engineering S.Y. Program` - 14 edges
10. `M.Sc. System Administration and Networking F.Y. Program` - 14 edges
